            ...
            <section class="banner-section">
                <div class="container">
                    <h2>All You Need for transport Creative &amp; Professional<a href="projects.html" class="button-one">Get Quote</a></h2>
                </div>
            </section>
            <!-- End banner section -->
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="offer-post">
                                <a href="services.html"><img src="<?= FRONTENDURL;?>/upload/others/con22.jpg" alt=""></a>
                                <h2><a href="services.html">PREPARING</a></h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="offer-post">
                                <a href="services.html"><img src="<?= FRONTENDURL;?>/upload/others/con2.jpg" alt=""></a>
                                <h2><a href="services.html">COLLECTING</a></h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="offer-post">
                                <a href="services.html"><img src="<?= FRONTENDURL;?>/upload/others/con3.jpg" alt=""></a>
                                <h2><a href="services.html">Reassembling</a></h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="news-box">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-post">
                                    <div class="news-gallery">
                                        <img src="<?= FRONTENDURL;?>/upload/others/ser1.jpg" alt="">
                                        <div class="date-post">
                            ...
                            <div class="col-sm-4">
                                <div class="news-post">
                                    <div class="news-gallery">
                                        <img src="<?= FRONTENDURL;?>/upload/others/ser2.jpg" alt="">
                                        <div class="date-post">
                            ...
                            <div class="col-sm-4">
                                <div class="news-post">
                                    <div class="news-gallery">
                                        <img src="<?= FRONTENDURL;?>/upload/others/ser3.jpg" alt="">
                                        <div class="date-post">
            ...
            <section class="projects-section">
                <div class="container">
                    <div class="project-title">
                        <h2>Latest from our gallery</h2>
                    </div>
                    <div class="project-box iso-call">
                        <div class="project-post buildings isolation">
                            <img src="<?= FRONTENDURL;?>/upload/projects/1.jpg" alt="">
                            <div class="hover-box">
                                <a class="zoom" href="<?= FRONTENDURL;?>/upload/projects/1.jpg"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="project-post interior">
                            <img src="<?= FRONTENDURL;?>/upload/projects/2.jpg" alt="">
                            <div class="hover-box">
                                <a class="zoom" href="<?= FRONTENDURL;?>/upload/projects/2.jpg"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="project-post buildings isolation">
                            <img src="<?= FRONTENDURL;?>/upload/projects/3.jpg" alt="">
                            <div class="hover-box">
                                <a class="zoom" href="<?= FRONTENDURL;?>/upload/projects/3.jpg"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="project-post buildings">
                            <img src="<?= FRONTENDURL;?>/upload/projects/4.jpg" alt="">
                            <div class="hover-box">
                                <a class="zoom" href="<?= FRONTENDURL;?>/upload/projects/4.jpg"><i class="fa fa-search"></i></a>
                            </div>
                        </div>s
                        <div class="project-post interior isolation">
                            <img src="<?= FRONTENDURL;?>/upload/projects/5.jpg" alt="">
                            <div class="hover-box">
                                <a class="zoom" href="<?= FRONTENDURL;?>/upload/projects/5.jpg"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="project-post energy">
                            <img src="<?= FRONTENDURL;?>/upload/projects/6.jpg" alt="">
                            <div class="hover-box">
                                <a class="zoom" href="<?= FRONTENDURL;?>/upload/projects/6.jpg"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <ul class="client-list">
                                <li>
                                    <a href="#"><img src="<?= FRONTENDURL;?>/images/clients/client1.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= FRONTENDURL;?>/images/clients/client2.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= FRONTENDURL;?>/images/clients/client3.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= FRONTENDURL;?>/images/clients/client4.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= FRONTENDURL;?>/images/clients/client5.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= FRONTENDURL;?>/images/clients/client6.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= FRONTENDURL;?>/images/clients/client1.png" alt=""></a>
                                </li>
